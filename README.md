...
6. The script works well on the free tier, but if the script adds a lot of cards to the context that are completely overcrowded, it can quickly run out of space, which is why the maximum number of cards is needed.
